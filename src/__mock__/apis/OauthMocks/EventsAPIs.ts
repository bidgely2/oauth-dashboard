...
import { CLIENTDATA } from "./EventsInfo";
...
mock
    ...
    .reply(200,CLIENTDATA.payload[0].EncryptDetail)
...
mock
    ...
    .reply(200,CLIENTDATA.payload[0].AppDomain)
...
mock  
    ...
    .reply(200,CLIENTDATA.payload[0].GrantManagement.PasswordGrant)
